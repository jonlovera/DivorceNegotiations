...
export default function Home() {
  return (
    <div>
      ...
      <div
        id="gettingStarted" className="background-primary" style={{
          paddingBottom: '70px',
        }}
      >
        <GettingStarted />
      ...
      <div
        id="faq" className="background-primary" style={{
          paddingBottom: '50px',
        }}
      >
      ...
      >
        <div
          href="/" className="brand-logo col offset-s1 offset-l1" style={{
            top: '50%',
